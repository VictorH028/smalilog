...
public class TermuxDocumentsProviderRoot extends DocumentsProvider {
    ...
    public void attachInfo(Context context, ProviderInfo info) {
        ...
        androidSdcardDir = new File("/storage/emulated/0");
    }
    ...
    private File getFileForDocId(String docId, boolean checkExists) throws FileNotFoundException {
        ...
        } else if (type.equalsIgnoreCase("sdcard")) {
            f = new File(androidSdcardDir, subPath);
        }
        if (f == null) {
            throw new FileNotFoundException(docId + " not found");
        }
    ...
    public Cursor queryChildDocuments(String parentDocumentId, String[] projection, String sortOrder) throws FileNotFoundException {
        ...
        if (parent == null) {
            ...
            if (userDeDataDir != null && userDeDataDir.exists()) {
                includeFile(result, parentDocumentId + "/user_de_data", userDeDataDir);
            }
            if (androidSdcardDir != null && androidSdcardDir.exists()) {
                includeFile(result, parentDocumentId + "/sdcard", androidSdcardDir);
            }
        } else {
    ...
    private void includeFile(MatrixCursor result, String docId, File file)
        ...
        } else if (androidSdcardDir != null && path.equals(androidSdcardDir.getPath())) {
            displayName = "sdcard";
        } else {
